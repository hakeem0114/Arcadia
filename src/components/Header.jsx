  ...
  return (
    <nav id='header' className=' w-full h-20 bg-white border-b-[2px] border-b-gray-800 opacity-95 flex justify-between  sticky z-50 top-0' >
          <div className='w-4/5 m-auto flex justify-between items-center' >
              <div className=" text-3xl font-bold text-gray-900 dark:text-white transform transition duration-300 hover:scale-110 hover:cursor-pointer">
              ...
              <div >
                  <ul className='hidden md:visible md:flex flex-row gap-16 ' >
                      ...
                      <li className='transform transition duration-300 hover:scale-110 hover:cursor-pointer'> <IoIosHome size={30} /> </li>
          ...
          {isDropDown &&
                                <ul className='visible absolute z-50 transform transition duration-300 hover:cursor-pointer
                                                 ...
                                                 md:hidden 
                                                ' >
                                        <li className='mt-7 transform transition duration-300  hover:scale-110 hover:text-slate-200 hover:cursor-pointer'> <IoIosHome size={50} /> </li>
                                        <li className='transform transition duration-300 hover:scale-110  hover:text-slate-200 hover:cursor-pointer'> <AiOutlineShoppingCart size={50}/> </li>
                                        <li className='transform transition duration-300 hover:scale-110  hover:text-slate-200 hover:cursor-pointer'> <IoIosContact size={50}/> </li>
                                </ul>
          }
    </nav>
  )
